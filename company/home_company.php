...
<body>
		...
		<ul class="choosea">
			<li> <a  href="/company/edit_details.php" class="btn btn-success chooseb">EDIT DETAILS</a> </li><br/> 
			<li> <a  href="/company/job.php" class="btn btn-success chooseb">JOBS</a></li><br/>
			<li> <a  href="/company/selected.php"class="btn btn-success chooseb"> SELECTED STUDENTS</a></li><br><br/>
		</ul>
