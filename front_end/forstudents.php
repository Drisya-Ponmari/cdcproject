...
<body>
		...
		<nav class="navbar navbar-expand-lg navbar navbar-light" style="background-color:#00FFFF;">
      		<a class="navbar-brand"><h3>Placement Cell </h3></a>
    		...
    		<ul class="navbar-nav ml-auto">
      			...
      			<li class="nav-link "><a href="/front_end/forstudents.php"style="color:red;"> <h6><b>ForStudent</b></h6></li>
		...
		<div class="text-center p-t-12">
			<div  class="text-center p-t-12">
				...
				<form class="login100-form validate-form" style="text-align:center;"action="backend/student_connect.php" method="POST">
