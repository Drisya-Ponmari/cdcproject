...
<body>
		...
		<nav class="navbar navbar-expand-lg navbar navbar-light" style="background-color:#00FFFF;">
    		...
    		<ul class="navbar-nav ml-auto">
      			...
      			<li class="nav-link"><a href="/front_end/forcompany.php"  style="color:red;"> <h6><b>ForCompany</b></h6></a></li>
		...
		<div class="text-center p-t-12">
			<div  class="text-center p-t-12">
				<div class="text-center p-t-12" data-tilt>
					 <img src="/images/company.jpeg" alt="IMG">
				</div>

				<form class="login100-form validate-form" style="text-align:center;"action="backend/company_connect.php" method="POST">
