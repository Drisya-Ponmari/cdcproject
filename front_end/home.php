...
<body>
		...
		<nav class="navbar navbar-expand-lg navbar navbar-light" style="background-color:#00FFFF;">
      		<a class="navbar-brand"><h3>Placement Cell </h3></strong> </a>
      		<div class="collapse navbar-collapse" id="navbarSupportedContent">
    		<ul class="navbar-nav ml-auto">
      			<li class="nav-link"><a href="/front_end/home.php" style="color:red;"> <h6><b> Home</b></h6></a></li>
      			...
      			<li class="nav-link"><a href="/front_end/login.php"> <h6><b>Login</b></h6></a></li>
    		</ul>
  			</div>
		</nav> 
  ...
  <div class="carousel-inner">
    ...
    <div class="carousel-item">
      <img src="/images/2.jpg" alt="Image" width="1100" height="500">
    </div>
    <div class="carousel-item">
      <img src="/images/5.jpg" alt="Image" width="1100" height="500">
    </div>
    <div class="carousel-item">
      <img src="/images/6.jpg" alt="Image" width="1100" height="500">
    </div>
  </div>
